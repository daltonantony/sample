...
public class SampleTest {
    ...
    public static void main(final String[] args) {
        ...
        final String fileLocation = "C:\\Code\\Others\\sample\\sample\\src\\sample\\sample_file.txt";
        final Map<String, Collection<?>> processedDetails = processor.processDetails(fileLocation);
